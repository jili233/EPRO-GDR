...
SOLVER = dict(
    IMS_PER_BATCH=72,
    TOTAL_EPOCHS=40,  # 30 | 13
    LR_SCHEDULER_NAME="flat_and_anneal",
    ANNEAL_METHOD="cosine",  # "cosine"
    ANNEAL_POINT=0.72,  # 0.72
    OPTIMIZER_CFG=dict(_delete_=True, type="Ranger", lr=8e-4, weight_decay=0.01),   # 8e-4
    WEIGHT_DECAY=0.0,
    WARMUP_FACTOR=0.001,
    WARMUP_ITERS=400,
)
...
DATALOADER = dict(
    ...
    NUM_WORKERS=48,
    FILTER_VIS4IB_THR=0.3,
)

MODEL = dict(
    WEIGHTS="output/gdrn/lmo_pbr/convnext_a6_AugCosyAAEGray_BG05_mlL1_DMask_amodalClipBox_classAware_lmo/model_final_wo_optim.pth",
    LOAD_DETS_TEST=True,
